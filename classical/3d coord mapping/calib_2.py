...
def triangulate(mtx1, mtx2, R, T):
    ...
    #uvs1 = [[315,357], [358, 357], [358, 400], [315, 400], [514, 409], [238, 84], [237, 268], [432, 228], [556, 229], [440, 348], [538, 348]]
    uvs1 = [[514, 409], [238, 84], [237, 268], [315,357], [358, 357], [358, 400], [315, 400]]
 
    #uvs2 = [[249, 342], [288, 341], [288, 379], [250, 379], [417, 384], [146, 112], [150, 268], [362, 228], [470, 228], [373, 330], [457, 330]]
    uvs2 = [[417, 384], [146, 112], [150, 268], [249, 342], [288, 341], [288, 379], [250, 379]]
 
    uvs1 = np.array(uvs1)
    uvs2 = np.array(uvs2)
 
 
    frame1 = cv.imread('test_img_pair/camera0_0.png')
    frame2 = cv.imread('test_img_pair/camera1_0.png')
